...
public class BrailleTranslateUtilsKorean {
  ...
  static {
      INITIAL_CONSONANTS_TRANSLATION_MAP.put("4", String.valueOf(INIT_CONSONANT_START_CHARACTER)) // ㄱ;
      INITIAL_CONSONANTS_TRANSLATION_MAP.put("6-4", String.valueOf((char) (INIT_CONSONANT_START_CHARACTER + 1))) // ㄲ;
      INITIAL_CONSONANTS_TRANSLATION_MAP.put("14", String.valueOf((char) (INIT_CONSONANT_START_CHARACTER + 2))) // ㄴ;
      INITIAL_CONSONANTS_TRANSLATION_MAP.put("24", String.valueOf((char) (INIT_CONSONANT_START_CHARACTER + 3))) // ㄷ;
      INITIAL_CONSONANTS_TRANSLATION_MAP.put("6-24", String.valueOf((char) (INIT_CONSONANT_START_CHARACTER + 4))) // ㄸ;
      INITIAL_CONSONANTS_TRANSLATION_MAP.put("5", String.valueOf((char) (INIT_CONSONANT_START_CHARACTER + 5))) // ㄹ;
      INITIAL_CONSONANTS_TRANSLATION_MAP.put("15", String.valueOf((char) (INIT_CONSONANT_START_CHARACTER + 6))) // ㅁ;
      INITIAL_CONSONANTS_TRANSLATION_MAP.put("45", String.valueOf((char) (INIT_CONSONANT_START_CHARACTER + 7))) // ㅂ;
      INITIAL_CONSONANTS_TRANSLATION_MAP.put("6-45", String.valueOf((char) (INIT_CONSONANT_START_CHARACTER + 8))) // ㅃ;
      INITIAL_CONSONANTS_TRANSLATION_MAP.put("6", String.valueOf((char) (INIT_CONSONANT_START_CHARACTER + 9))) // ㅅ;
      INITIAL_CONSONANTS_TRANSLATION_MAP.put("6-6", String.valueOf((char) (INIT_CONSONANT_START_CHARACTER + 10))) // ㅆ;
      INITIAL_CONSONANTS_TRANSLATION_MAP.put("1245", String.valueOf((char) (INIT_CONSONANT_START_CHARACTER + 11))) // ㅇ;
      INITIAL_CONSONANTS_TRANSLATION_MAP.put("46", String.valueOf((char) (INIT_CONSONANT_START_CHARACTER + 12))) // ㅈ;
      INITIAL_CONSONANTS_TRANSLATION_MAP.put("6-46", String.valueOf((char) (INIT_CONSONANT_START_CHARACTER + 13))) // ㅉ;
      INITIAL_CONSONANTS_TRANSLATION_MAP.put("56", String.valueOf((char) (INIT_CONSONANT_START_CHARACTER + 14))) // ㅊ;
      INITIAL_CONSONANTS_TRANSLATION_MAP.put("124", String.valueOf((char) (INIT_CONSONANT_START_CHARACTER + 15))) // ㅋ;
      INITIAL_CONSONANTS_TRANSLATION_MAP.put("125", String.valueOf((char) (INIT_CONSONANT_START_CHARACTER + 16))) // ㅌ;
      INITIAL_CONSONANTS_TRANSLATION_MAP.put("145", String.valueOf((char) (INIT_CONSONANT_START_CHARACTER + 17))) // ㅍ;
      INITIAL_CONSONANTS_TRANSLATION_MAP.put("245", String.valueOf((char) (INIT_CONSONANT_START_CHARACTER + 18))) // ㅎ;
  }

  private static final Map<String, String> VOWEL_TRANSLATION_MAP = new HashMap<>();
  static {
      VOWEL_TRANSLATION_MAP.put("126", String.valueOf(VOWEL_CONSONANT_START_CHARACTER)) // ㅏ;
      VOWEL_TRANSLATION_MAP.put("1235", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 1))) // ㅐ;
      VOWEL_TRANSLATION_MAP.put("345", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 2))) // ㅑ;
      VOWEL_TRANSLATION_MAP.put("345-1235", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 3))) // ㅒ;
      VOWEL_TRANSLATION_MAP.put("234", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 4))) // ㅓ;
      VOWEL_TRANSLATION_MAP.put("1345", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 5))) // ㅔ;
      VOWEL_TRANSLATION_MAP.put("156", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 6))) // ㅕ;
      VOWEL_TRANSLATION_MAP.put("34", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 7))) // ㅖ;
      VOWEL_TRANSLATION_MAP.put("136", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 8))) // ㅗ;
      VOWEL_TRANSLATION_MAP.put("1236", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 9))) // ㅘ;
      VOWEL_TRANSLATION_MAP.put("1236-1235", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 10))) // ㅙ;
      VOWEL_TRANSLATION_MAP.put("13456", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 11))) // ㅚ;
      VOWEL_TRANSLATION_MAP.put("346", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 12))) // ㅛ;
      VOWEL_TRANSLATION_MAP.put("134", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 13))) // ㅜ;
      VOWEL_TRANSLATION_MAP.put("1234", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 14))) // ㅝ;
      VOWEL_TRANSLATION_MAP.put("1234-1235", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 15))) // ㅞ;
      VOWEL_TRANSLATION_MAP.put("134-1235", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 16))) // ㅟ;
      VOWEL_TRANSLATION_MAP.put("146", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 17))) // ㅠ;
      VOWEL_TRANSLATION_MAP.put("246", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 18))) // ㅡ;
      VOWEL_TRANSLATION_MAP.put("2456", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 19))) // ㅢ;
      VOWEL_TRANSLATION_MAP.put("135", String.valueOf((char) (VOWEL_CONSONANT_START_CHARACTER + 20))) // ㅣ;
  }
  private static final Map<String, String> FINAL_CONSONANTS_TRANSLATION_MAP = new HashMap<>();
  static {
      FINAL_CONSONANTS_TRANSLATION_MAP.put("1", String.valueOf(FINAL_CONSONANT_START_CHARACTER)) // ㄱ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("1-1", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 1))) // ㄲ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("1-3", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 2))) // ㄳ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("25", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 3))) // ㄴ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("25-13", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 4))) // ㄵ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("25-356", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 5))) // ㄶ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("35", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 6))) // ㄷ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("2", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 7))) // ㄹ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("2-1", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 8))) // ㄺ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("2-26", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 9))) // ㄻ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("2-12", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 10))) // ㄼ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("2-3", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 11))) // ㄽ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("2-236", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 12))) // ㄾ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("2-256", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 13))) // ㄿ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("2-356", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 14))) // ㅀ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("26", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 15))) // ㅁ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("12", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 16))) // ㅂ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("12-3", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 17))) // ㅄ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("3", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 18))) // ㅅ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("34", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 19))) // ㅆ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("2356", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 20))) // ㅇ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("13", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 21))) // ㅈ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("23", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 22))) // ㅊ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("235", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 23))) // ㅋ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("236", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 24))) // ㅌ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("256", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 25))) // ㅍ;
      FINAL_CONSONANTS_TRANSLATION_MAP.put("356", String.valueOf((char) (FINAL_CONSONANT_START_CHARACTER + 26))) // ㅎ;
  }
  ...
  static {
      ...
      OPEN_SYMBOL_TRANSLATION_MAP.put("236-3", "(");
      OPEN_SYMBOL_TRANSLATION_MAP.put("236-2", "{");
      OPEN_SYMBOL_TRANSLATION_MAP.put("236-23", "[");
      OPEN_SYMBOL_TRANSLATION_MAP.put("5-236", "<");
      OPEN_SYMBOL_TRANSLATION_MAP.put("56-236", "《");
      OPEN_SYMBOL_TRANSLATION_MAP.put("456-236", "?");
      OPEN_SYMBOL_TRANSLATION_MAP.put("456-34", "/");
      OPEN_SYMBOL_TRANSLATION_MAP.put("4-2456", "￦");
      OPEN_SYMBOL_TRANSLATION_MAP.put("4-145", "$");
      OPEN_SYMBOL_TRANSLATION_MAP.put("26", "+");
      OPEN_SYMBOL_TRANSLATION_MAP.put("35", "-");
      OPEN_SYMBOL_TRANSLATION_MAP.put("25-25", "=");
      OPEN_SYMBOL_TRANSLATION_MAP.put("36-36", "~");
      OPEN_SYMBOL_TRANSLATION_MAP.put("36", "-");
      OPEN_SYMBOL_TRANSLATION_MAP.put("235", "!");
      OPEN_SYMBOL_TRANSLATION_MAP.put("256", ".");
  }
